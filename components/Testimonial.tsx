    ...
    <div className="p-4 font-sf-pro lg:min-h-screen 2xl:min-h-0 2xl:h-full">
      <div className="max-w-7xl 2xl:max-w-[1400px] mx-auto px-4 2xl:px-8">
        ...
        <div className="flex flex-col mb-4">
          <h1 className="text-center font-bold text-6xl 2xl:text-7xl mt-8">
            Trusted By Experts
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mx-8 2xl:max-w-6xl 2xl:mx-auto">
