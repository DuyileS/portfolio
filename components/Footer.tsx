    ...
    >
      <div className="max-w-7xl 2xl:max-w-[1400px] mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center py-6">
          ...
          <div className="w-full mt-4 md:mt-0 md:w-[40%] 2xl:max-w-md border border-x-0 mr-8">
        ...
        <div className="flex justify-between 2xl:justify-around items-center py-4 px-8">
          <Link href={"/"}>
            <Image
              ...
              height={50} 
              width={250}
              className="filter hidden md:inline invert md:ml-24 lg:ml-24 2xl:ml-32"
            />
          </Link>
          <div className="rounded max-w-md 2xl:max-w-lg">
            <video className="h-[250px] 2xl:h-[300px] w-full rounded-lg" autoPlay loop muted>
