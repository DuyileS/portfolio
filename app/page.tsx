        ...
        <div className="relative z-10 px-8 py-12 text-white overflow-x-hidden">
          <div className="max-w-7xl 2xl:max-w-[1400px] mx-auto">
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center pt-[120%] md:pt-80 lg:pt-48 mt-20 md:mt-110 2xl:mt-[calc(100vh-35vh)] lg:mt-0">
              ...
              <div className="flex flex-col mt-4 lg:mt-0 lg:w-1/3 2xl:max-w-md">
                <Image
                  src={"/dm_globe.png"}
                  alt="Globe"
                  width={100}
                  height={100}
                  className="md:ml-16 hidden lg:inline lg:ml-48 2xl:ml-32 mb-4"
                />
                <p className="font-semibold font-sf-pro-display text-lg md:text-2xl">
                  <span className="lg:pl-24 2xl:pl-32">{homeDescription}</span>
                </p>
              </div>
            </div>
          </div>
